...
@Component({
  selector: 'app-constanteTempo-list',
  templateUrl: './constanteTempo-list.component.html'
})
export class ConstanteTempoListComponent extends BaseResourceListComponent<Object> {
  ...
  constructor(
    ...
    super(new BaseService(environment.apiSistema + "/api/ConstanteTempo/", injector));
  }
