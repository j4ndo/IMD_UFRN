...
@Component({
  selector: 'app-regraato-list',
  templateUrl: './regraato-list.component.html'
})
export class RegraAtoListComponent extends BaseResourceListComponent<Object> {
  ...
  constructor(
    ...
    super(new BaseService(environment.apiSistema + "/api/RegraAto/", injector));
  }
