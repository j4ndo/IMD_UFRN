...
@Component({
  selector: 'app-cargaHoraria-list',
  templateUrl: './cargaHoraria-list.component.html'
})
export class CargaHorariaListComponent extends BaseResourceListComponent<Object> {
  ...
  constructor(
    ...
    super(new BaseService(environment.apiSistema + "/api/CargaHoraria/", injector));
